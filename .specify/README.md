...
| `memory/SETUP-CASTELLANO-BDD.md` | Guía detallada de configuración |
| `templates/overrides/` | **Tus templates en castellano** (EARS + Gherkin) |
...
```bash
cat .specify/memory/SETUP-CASTELLANO-BDD.md
```
